      ...
      <div className="w-11/12 sm:w-3/4 mx-auto justify-center items-center my-48">
        ...
        >
          <Markdown
            ...
            className="prose prose-headings:text-gray-50 prose-p:text-gray-50 prose-blockquote:text-gray-50 prose-strong:text-gray-50 prose-code:text-gray-50 text-gray-50"
          >
            {result}
          </Markdown>
          <Button
